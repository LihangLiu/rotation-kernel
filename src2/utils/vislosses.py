...
if __name__ == '__main__':
    txt_list = [        
        ...
        # ('../../outputs/losses/loss_3d_rot_lrdecay.csv', 'alter'),
        ...
        # weight sharing
        # ('../../outputs/losses/loss_modelnet_3d_share1.csv', ''),
        # ('../../outputs/losses/loss_modelnet_3d_rot_share1.csv', ''),

        # mn
        # ('../../outputs/losses/loss_modelnet_3d.csv', ''),  # nf = 16

        ('../../outputs/losses/loss_modelnet_3d_nf22.csv', ''),
        ('../../outputs/losses/loss_modelnet_3d_mn_init1_nt2.csv', ''),

        ('../../outputs/losses/loss_modelnet_3d_nf32.csv', ''),
        # ('../../outputs/losses/loss_modelnet_3d_mn_init1_nt3.csv', ''),
        ('../../outputs/losses/loss_modelnet_3d_mn_init1_nt4.csv', ''),     # nf = 16
        # ('../../outputs/losses/loss_modelnet_3d_mn_init2_nt3.csv', ''),
        # ('../../outputs/losses/loss_modelnet_3d_mn_init3_nt3.csv', ''),
        # ('../../outputs/losses/loss_modelnet_3d_mn_init4.csv', ''),

        ('../../outputs/losses/loss_vox64_3d.csv', ''),
        ('../../outputs/losses/loss_modelnet64_3d_mn_init1_nt4.csv', ''),
    ]
